...
export default function CalendarPage() {
  ...
  const handlePrint = (e) => {
    ...
    try {
      ...
      // 以下のHTML構造は、お客様のコードを一字一句変えていません（省略処理なし）
        ...
        <head>
          ...
          <style>
            ...
            * {
            ...
            .page {
              width: 194mm;
              /* min-heightは残しつつ、中身が増えたら自然に伸びるようにします */
              min-height: 277mm;
              margin: 0 auto 8mm;
              background: #fff;
              padding: 0;
